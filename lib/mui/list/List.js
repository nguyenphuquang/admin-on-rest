...
var List = exports.List = function (_Component) {
    ...
    function List(props) {
        ...
        _this.setFilters = function (filters) {
            _this.changeParams({ type: _queryReducer.SET_FILTER, payload: filters });
        };
    ...
    (0, _createClass3.default)(List, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_Card.CardTitle, { title: _react2.default.createElement(_Title2.default, { title: this.props.titleComponent || title, defaultTitle: _inflection2.default.humanize(_inflection2.default.pluralize(resource)) + ' List' }) }),
...
List.propTypes = {
    ...
    filters: _react.PropTypes.object, // eslint-disable-line react/forbid-prop-types
...
function mapStateToProps(state, props) {
    ...
    var middleware = props.route.middleware;
