        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                nbPages > 1 && _react2.default.createElement(
                    _Toolbar.ToolbarGroup,
                    null,
                    page > 1 && _react2.default.createElement(_FlatButton2.default, { primary: true, key: 'prev', label: translate('aor.navigation.prev'), icon: _react2.default.createElement(_chevronLeft2.default, null), onClick: this.prevPage, style: buttonStyle }),
                    this.renderPageNums(),
                    page !== nbPages && _react2.default.createElement(_FlatButton2.default, { primary: true, key: 'next', label: translate('aor.navigation.next'), icon: _react2.default.createElement(_chevronRight2.default, null), labelPosition: 'before', onClick: this.nextPage, style: buttonStyle })
                )
            );
        }
    }]);
...
exports.default = (0, _translate2.default)((0, _pure2.default)(Pagination));