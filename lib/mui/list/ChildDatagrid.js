...
var ChildDatagrid = (0, _reactRouter.withRouter)(function (_Component) {
    (0, _inherits3.default)(_ChildDatagrid, _Component);

    function _ChildDatagrid(props) {
        (0, _classCallCheck3.default)(this, _ChildDatagrid);

        var _this = (0, _possibleConstructorReturn3.default)(this, (_ChildDatagrid.__proto__ || Object.getPrototypeOf(_ChildDatagrid)).call(this, props));
    ...
    (0, _createClass3.default)(_ChildDatagrid, [{
        key: 'onDelete',
        ...
        key: 'onClick',
        value: function onClick(item, id, editTitle) {
            this.setState({
                _currentRecord: item,
                _currentId: id,
                open: true,
        ...
        value: function onSave(newData) {
            ...
            this.props.route.store.dispatch((0, _reduxForm.stopSubmit)());
        }
    }, {
        key: 'getData',
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                edit = _props.edit,
                input = _props.input,
                _props$canEdit = _props.canEdit,
                canEdit = _props$canEdit === undefined ? true : _props$canEdit,
                _props$canDelete = _props.canDelete,
                canDelete = _props$canDelete === undefined ? true : _props$canDelete,
                _props$canAdd = _props.canAdd,
                canAdd = _props$canAdd === undefined ? true : _props$canAdd,
            ...
            return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            canAdd && _react2.default.createElement(
                                ...
                                _react2.default.createElement(_FlatButton2.default, { primary: true, label: 'Add',
                        ...
                        data.map(function (row, id) {
                            return _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    canEdit && _react2.default.createElement(_FlatButton2.default, { primary: true, label: 'Edit', onClick: _this2.onClick.bind(_this2, row, id, 'Edit record') }),
                                    canDelete && _react2.default.createElement(_FlatButton2.default, { primary: true, label: 'Delete', onClick: _this2.onDelete.bind(_this2, row, id) })
                                )
                            );
                        })
                    )
                ...
                this.state.open ? _react2.default.createElement(
                    _Dialog2.default,
                    { open: this.state.open, title: this.state.editTitle,
