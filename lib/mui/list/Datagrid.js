                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.Children.map(children, function (field, index) {
                            return _react2.default.createElement(
                                ...
                                { key: field.props.source || index, style: Object.assign({}, index ? styles.th : styles['th:first-child'], { textAlign: field.props.align || 'left' }) },
                        ...
                        return _react2.default.createElement(
                            ...
                            _react2.default.Children.toArray(children).map(function (field, index) {
                                return _react2.default.createElement(
                                    ...
                                    { key: id + '-' + (field.props.source || index), style: Object.assign({}, index ? styles.td : styles['td:first-child'], { textAlign: field.props.align || 'center' }) },
