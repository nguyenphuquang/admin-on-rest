...
var FilterForm = exports.FilterForm = function (_Component) {
    ...
    (0, _createClass3.default)(FilterForm, [{
        ...
        value: function getShownFilters() {
            ...
            var ret = filters.filter(function (filterElement) {
        ...
        value: function render() {
            ...
            console.log('======currentFilter', { currentFilters: currentFilters });
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(
                    _Card.CardText,
                    { style: (0, _extends3.default)({ float: 'right', marginTop: '-14px', paddingTop: 0 }, style) },
                    this.getShownFilters().map(function (filterElement) {
                        return _react2.default.createElement(
                            'div',
                            { key: filterElement.props.source, style: filterElement.props.style },
