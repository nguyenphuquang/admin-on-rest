...
var Logout = function (_Component) {
    ...
    (0, _createClass3.default)(Logout, [{
        ...
        value: function render() {
            ...
            return authClient ? _react2.default.createElement(
                _List.List,
                null,
                _react2.default.createElement(_List.ListItem, { leftIcon: _react2.default.createElement(_powerSettingsNew2.default, null), primaryText: translate('aor.auth.logout'), onClick: this.handleLogout })
            ) : null;
        }
    }]);
    return Logout;
