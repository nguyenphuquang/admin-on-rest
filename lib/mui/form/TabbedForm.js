                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.Children.map(children, function (tab, index) {
                            return _react2.default.createElement(
                                _Tabs.Tab,
                                { key: tab.props.value, label: tab.props.label, value: index, icon: tab.props.icon },
...
var mapStateToProps = function mapStateToProps(state, props) {
    return {
        initialValues: (0, _getDefaultValues2.default)(_react.Children.toArray(props.children))(props.record, props.defaultValue)
    };
};
