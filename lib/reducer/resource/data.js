...
var addRecords = function addRecords() {
    ...
    var oldValidRecordIds = Object.keys(oldRecords.fetchedAt).filter(function (id) {
    ...
    return function () {
        ...
        switch (type) {
            ...
            case _dataActions.CRUD_UPDATE:
                // replace record in edit form with edited one to avoid displaying previous record version
                return addRecords([payload.data], previousState);
